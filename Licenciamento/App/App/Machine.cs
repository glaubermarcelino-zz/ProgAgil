...
namespace App
{
    ...
    {
        public RestResponse<Machine> GetMachineId(string id)
        {
            throw new NotImplementedException();
        }
        public Machine()
        {
            string machineId = GetMachineIdLocal();
            var retorno = this.AutenticateMachine(machineId);
        }
        ...
        public RestResponse<Machine> GetMachinePermission(int id, int limit,string test)
        {
            throw new NotImplementedException();
        }
